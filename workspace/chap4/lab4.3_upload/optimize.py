...
def loss_function(net, content_features, style_features, content_weight, style_weight, tv_weight, preds, batch_size):
    ...
    content_loss = content_weight * tf.reduce_sum(tf.square(net[CONTENT_LAYER] - content_features[CONTENT_LAYER])) / content_size
    ...
    for style_layer in STYLE_LAYERS:
        ...
        style_losses.append(tf.nn.l2_loss(grams - style_gram) / size)
...
def optimize(content_targets, style_target, content_weight, style_weight,
    ...
    with tf.Graph().as_default(), tf.device('/cpu:0'), tf.Session() as sess:
        ...
        net = vgg.preprocess(style_image)
        net = vgg.net(vgg_path, net)
        ...
        content_loss, style_loss, tv_loss, loss = \
            loss_function(net, content_features, style_features, content_weight, style_weight, tv_weight, preds, batch_size)
